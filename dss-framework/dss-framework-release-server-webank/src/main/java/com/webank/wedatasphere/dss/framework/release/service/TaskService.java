...
public interface TaskService {
    ...
    ReleaseTask addReleaseTask(String releaseUser, Long projectId, Long orchestratorId, Long orchestratorVersionId, String orchestratorName,String comment, String instanceName);
