...
public class OrchestratorReleaseJob extends AbstractReleaseJob{
    ...
    public void run() {
        String errmsg = "";
        LOGGER.info("trace workflow publish,flowId:{},orchestratorId:{}.收到发布任务 request releaseUser is {}.",
        ...
        try{
            ...
            //1.进行导出
            LOGGER.info("trace workflow publish,flowId:{},orchestratorId:{}.开始导出 request releaseUser is {}.",
                    request.getOrcAppId(),orchestratorId,releaseUser );
            ...
            LOGGER.info("trace workflow publish,flowId:{},orchestratorId:{}.导出成功 request releaseUser is {}.",
                    request.getOrcAppId(),orchestratorId,releaseUser );
            ...
            LOGGER.info("trace workflow publish,flowId:{},orchestratorId:{}.开始导入 request releaseUser is {}.",
                    request.getOrcAppId(),orchestratorId,releaseUser );
            OrchestratorImportInfo importOrcInfos = this.releaseEnv.getImportService().importOrc(orchestratorName, releaseUser,
                    projectInfo.getProjectId(),projectInfo.getProjectName(), resourceList, nextLabel, workspaceName, workspace);
            LOGGER.info("trace workflow publish,flowId:{},orchestratorId:{}.导入成功 request releaseUser is {}.",
                    request.getOrcAppId(),orchestratorId,releaseUser );
