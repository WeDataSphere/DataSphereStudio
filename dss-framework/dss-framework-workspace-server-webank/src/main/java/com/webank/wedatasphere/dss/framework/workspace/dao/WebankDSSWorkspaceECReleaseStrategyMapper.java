 ...
 */
@Mapper
public interface WebankDSSWorkspaceECReleaseStrategyMapper {
    ...
    ECReleaseStrategyDO getStrategyByQueueName(@Param("queueName")String queueName,@Param("crossCluster")int crossCluster);
