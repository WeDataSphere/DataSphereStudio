...
public class ECConfigTemplateDO implements Serializable {
    ...
    /**
     * 是否为AI SQL的默认模板，0为否，1为是
     */
    private Integer defaultForAISQL;
     ...
     * 是否为AI SQL的默认模板，0为否，1为是
     */
    public Integer getDefaultForAISQL() {
        return defaultForAISQL;
    }

    /**
     * 是否为AI SQL的默认模板，0为否，1为是
     */
    public void setDefaultForAISQL(Integer defaultForAISQL) {
        this.defaultForAISQL = defaultForAISQL;
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getModifyTime() == null ? other.getModifyTime() == null : this.getModifyTime().equals(other.getModifyTime()))
                && (this.getDefaultForAISQL() == null ? other.getDefaultForAISQL() == null : this.getDefaultForAISQL().equals(other.getDefaultForAISQL()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDefaultForAISQL() == null) ? 0 : getDefaultForAISQL().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", defaultForAISQL=").append(defaultForAISQL);
