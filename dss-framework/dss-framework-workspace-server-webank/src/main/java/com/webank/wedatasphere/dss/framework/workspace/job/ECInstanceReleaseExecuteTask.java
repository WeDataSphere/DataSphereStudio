...
public class ECInstanceReleaseExecuteTask {
    ...
    @Async("dssEcReleaseScheduledExecutor")
    ...
    public void executeStrategy(){
        ...
        try {
            ...
            for (ECReleaseStrategyJob strategy : strategies) {
                ...
                //更新成功则说明抢锁成功
                if (webankDSSWorkspaceECReleaseStrategyMapper.casSwapExecuteInstance(strategyId, expectExecuteInstance
                    ...
                    try {
                        ...
                        webankDSSWorkspaceECReleaseStrategyMapper.cleanExecuteInfo(strategyId);
                    }
                }
            }
        }finally {
    ...
    private void processStrategy(ECReleaseStrategy strategy, String operator,String executeInstance, QueueInfo queueInfo){
        ...
        if (satisfy(maxCores, maxMemory, usedCores, usedMemory, triggerCondition, true)) {
            ...
            if(!killHistoryRecordList.isEmpty()){
                ...
                webankDSSWorkspaceECKillHistoryService.batchAddEcKillRecord(killHistoryRecordList);
