...
public class ImportServiceImpl implements ImportService {
    ...
    public OrchestratorReleaseInfo importOrc(String orchestratorName, String releaseUser,Long projectId, String projectName,
        ...
        OrchestratorReleaseInfo orchestratorReleaseInfo =null;
...
//        RefImportOperation<OrchestratorImportRequestRef> refImportOperation = refImportService.getRefImportOperation();
...
//                importRequestRef.setSourceEnv(IOEnv.BDAP_DEV);
                ...
                orchestratorReleaseInfo=OrchestratorReleaseInfo.newInstance(refOrcId, orchestratorName,orchestratorVersion);
            } catch (Exception e) {
    ...
    public OrchestratorBatchImportInfo batchImportOrc(String userName, Long projectId, String projectName,
        ...
        Type type=new TypeToken<List<OrchestratorDetail>>(){}.getType();
        List<OrchestratorDetail> importOrcs=new Gson().fromJson(metaJson,type);

        Iterator<File> iterator= FileUtils.iterateFiles(new File(unzipImportFile),new String[]{"zip"},false);
        List<OrchestratorReleaseInfo> importResultInfo = new ArrayList<>();
        while (iterator.hasNext()){
            ...
            OrchestratorReleaseInfo importInfo = importOrc(orcName, userName, projectId, projectName, uploadResult, dssLabel, workspace.getWorkspaceName(), workspace);
