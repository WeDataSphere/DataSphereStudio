            ...
            if (eror) {
              ...
              if (isFile) {
                ...
                values.forEach((it) => {
                  ...
                  content = content.replace(attrReg, ` :$1="$t('message.exts${key}')"`)
                  content = content.replace(tagReg, `>$1{{ $t('message.exts${key}') }}$2<`)
                  content = content.replace(jsReg, `this.$t('message.exts${key}')`)
                })
