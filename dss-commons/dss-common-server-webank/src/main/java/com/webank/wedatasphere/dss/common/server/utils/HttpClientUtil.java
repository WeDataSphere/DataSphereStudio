...
public class HttpClientUtil {
    ...
    public final static int defaultConnectTimeout = 5000;
    ...
    public static void postJsonBody(String url, Map<String, String> headerMap, String paraData) {
        postJsonBody(url,headerMap,paraData,(Integer) null);

    }

    /**
     *
     * @param connectTimeout 超时时间，Null表示用默认超时时间
     */
    public static void postJsonBody(String url, Map<String, String> headerMap, String paraData,Integer connectTimeout) {
    ...
    public static void postForm(String url, Map<String, Object> header, List<NameValuePair> params) {
        postForm(url,header,params,null);
    }
    /**
     *
     * @param connectTimeout 超时时间，Null表示用默认超时时间
     */
    public static void postForm(String url, Map<String, Object> header, List<NameValuePair> params ,Integer connectTimeout) {
        if (connectTimeout == null) {
            connectTimeout = defaultConnectTimeout;
        }
        HttpPost post = new HttpPost(url);
    ...
    public static SimpleHttpResponse postForm(String url, int timeout, Map<String, Object> headerMap,
                                              List<NameValuePair> paramsList, String encoding, Integer connectTimeout){
        if (connectTimeout == null) {
            connectTimeout = defaultConnectTimeout;
        }
        HttpPost post = new HttpPost(url);
    ...
    public static SimpleHttpResponse postJsonBody(String url, Map<String, String> headerMap,
                                                  String paraData, String encoding,Integer connectTimeout) {
        if(connectTimeout == null){
            connectTimeout = defaultConnectTimeout;
        }
        logger.info("successfully  start post Json Body  url{} ", url);
    ...
    public static SimpleHttpResponse invokeGet(String url,Map<String,String>headerMap, Map<String, String> params,
                                               String encode,Integer connectTimeout) {
        if(connectTimeout == null){
            connectTimeout = defaultConnectTimeout;
        }
        ...
        if(statusCode != 200) {
            logger.error("statusCode:{},responseString：{}", statusCode, responseString);
        }
