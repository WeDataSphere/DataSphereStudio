package com.webank.wedatasphere.dss.common.server.esb.http;
...
public class HttpStaffInfoGetter implements StaffInfoGetter {
    ...
    private static final Map<String, StaffInfo> STAFF_INFO_MAP = new ConcurrentHashMap<>();
    private static final Object LOCK = new Object();

    private static final String DEFAULT_DEPARTMENT = "基础科技产品部-大数据平台室";
    ...
    private static class StaffThread implements Runnable {
        ...
        private static final String GROUP = "群";
    ...
    public StaffInfo getStaffInfoByUsername(String username) {
        ...
        return STAFF_INFO_MAP.get(username);
    }
