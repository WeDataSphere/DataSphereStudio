...
public class DSSServerSenderServiceInnerImpl extends DSSServerSenderServiceImpl {

    //    private final Sender dssServerSenderDev = Sender.getSender(DSSAdaptorInnerConf.DSS_SERVER_NAME_DEV.getValue());
    private final Sender dssServerSenderProd = Sender.getSender(DSSAdaptorInnerConf.DSS_SERVER_NAME_PROD.getValue());
