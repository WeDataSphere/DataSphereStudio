...
package com.webank.wedatasphere.dss.errorcode.server.service;
...
public interface LinkisErrorCodeService {
    ...
    public List<ErrorCodeReport> getAllErrorReports(String reportBy,
                                                    Date startTime,
                                                    Date endTime);

    void addTaskProblem(String requestUrl, String requestBody, String requestHeaders,
