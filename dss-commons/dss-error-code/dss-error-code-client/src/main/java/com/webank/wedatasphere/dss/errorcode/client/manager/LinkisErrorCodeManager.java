...
package com.webank.wedatasphere.dss.errorcode.client.manager;

import com.webank.wedatasphere.dss.errorcode.client.synchronizer.LinkisErrorCodeSynchronizer;
...
public class LinkisErrorCodeManager {
    ...
    public static synchronized LinkisErrorCodeManager getInstance() {
