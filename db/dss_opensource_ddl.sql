...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_bin  COMMENT='dss appconn表';
...
CREATE TABLE `dss_appconn_instance` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_bin COMMENT='dss instance的实例表';
...
CREATE TABLE `dss_orchestrator_info` (
   ...
   `is_default_reference` tinyint(1) DEFAULT NULL COMMENT '是否默认引用资源参数模板',
   `update_user` varchar(100) DEFAULT NULL COMMENT '更新人',
   `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
   `data_source_list_json` TEXT   COMMENT '项目数据源配置，json格式',
   `status` VARCHAR(64) DEFAULT NULL,
   `bml_version` VarChar(255) DEFAULT NULL,
   `resource_id` VarChar(255) DEFAULT NULL,
   `not_contains_keywords_node`  LONGTEXT DEFAULT NULL COMMENT '不包含关键字的节点信息',
...
CREATE TABLE `dss_project` (
  ...
  `label` varchar(128) DEFAULT NULL COMMENT '标签，用于区分不同来源请求创建的项目',
  `data_source_list_json` TEXT COMMENT '项目数据源配置，json格式',
  PRIMARY KEY (`id`)
...
CREATE TABLE `dss_project_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4  COMMENT ='项目权限表' COLLATE=utf8mb4_bin ;
...
CREATE TABLE `dss_workspace` (
  ...
  `enabled_flow_keywords_check` tinyint(1) DEFAULT 0 COMMENT '是否开启工作流关键字校验,1、启用 0、禁用',
  `is_default_reference` tinyint(1) DEFAULT 0 COMMENT '是否默认引用资源参数模板,1、是 0、否',
  PRIMARY KEY (`id`),
...
CREATE TABLE `dss_workspace_homepage` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1213 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ;
...
CREATE TABLE `dss_workspace_dictionary` (
  ...
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_unique_workspace_id` (`workspace_id`,`dic_key`(150)),
  KEY `idx_parent_key` (`parent_key`(150)),
  KEY `idx_dic_key` (`dic_key`(150))
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_bin COMMENT='数据字典表';
...
CREATE TABLE `dss_workspace_role` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `workspace_id` (`workspace_id`(80),`name`(80))
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_bin CHECKSUM=1 DELAY_KEY_WRITE=1;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin  COMMENT='侧边栏表';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_bin COMMENT='侧边栏-内容表';
...
CREATE TABLE `dss_workspace_download_audit`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
	 PRIMARY KEY (`id`)
) ENGINE = INNODB DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_bin COMMENT = '文件下载审计';
...
CREATE TABLE `dss_workflow` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=455 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ;
...
CREATE TABLE `dss_workflow_task` (
  ...
  KEY `um_user` (`um_user`)
) ENGINE=InnoDB AUTO_INCREMENT=715 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ;
...
CREATE TABLE `dss_workflow_node_ui` (
  ...
  `lable_name` varchar(128) NOT NULL,
...
CREATE TABLE `dss_workspace_menu_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5263 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ;
...
CREATE TABLE `dss_workspace_appconn_role` (
  ...
  `updateby` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5103 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin  comment '空间用户表';
...
CREATE TABLE `dss_workspace_user_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_bin comment '空间用户角色关系表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin  COMMENT ='编排复制信息表';
...
(
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_bin COMMENT ='项目操作记录表';
 ...
 CREATE TABLE `dss_orchestrator_job_info` (
    ...
    PRIMARY KEY (`id`)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_bin  COMMENT='dss_orchestrator_job_info表';
  ...
  CREATE TABLE `dss_project_copy_task` (
    ...
    PRIMARY KEY (`id`)
  ) ENGINE=INNODB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_bin COMMENT='复制工程任务表';
...
CREATE TABLE `dss_project_associate_git` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
   ...
   `workspace_id` bigint(20) DEFAULT NULL,
   `git_user`  varchar(255)  DEFAULT NULL COMMENT  'git登录用户名',
   `git_token`  varchar(255) COMMENT  '用户配置的git token',
   `git_url` varchar(255),
   `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
PARTITION BY LIST COLUMNS(`node_type`) (
    PARTITION `p_python` VALUES IN ('linkis.python.python'),
...
CREATE TABLE `dss_project_orchestrator_white` (
  ...
  `reason` text COLLATE utf8mb4_bin COMMENT '原因',
