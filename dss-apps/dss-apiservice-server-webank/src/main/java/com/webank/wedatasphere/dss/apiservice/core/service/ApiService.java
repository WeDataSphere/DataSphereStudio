...
//    void saveByApp(ApiServiceVo apiService) throws Exception;
    ...
    List<ApiServiceVo> queryByWorkspaceId(Integer workspaceId, String userName, String type);
    ...
    boolean isExistsJdbcApi(List<Long> apiId);

    ApiServiceVo checkSubmitApi(List<Long> apiVersionId);
