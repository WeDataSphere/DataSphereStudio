...
public class LinkisJobSubmit {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(LinkisJobSubmit.class);

    public static UJESClient getClient(Map<String, String> props) {

        UJESClient client = getUJESClient(
                ApiServiceConfiguration.LINKIS_URL_1_X.getValue(props),
    ...
    public static JobExecuteResult execute(ApiServiceExecuteJob job, UJESClient client) {
        ...
        JobExecuteResult res = execute(job, client, "IDE");
        return res;
    }
    ...
    public static JobExecuteResult execute(ApiServiceExecuteJob job, UJESClient client, String creator) {
        ...
        LOGGER.info("execute uri is {}, params is {}", res.getUri(), jobAction.getRequestPayload());
        return res;
    }


    public static JobExecuteResult executeNew(ApiServiceExecuteJob job, UJESClient client, String creator) {
        ...
        JobExecuteAction.Builder builder = JobExecuteAction.builder().setCreator(creator)
                ...
                .setUser(job.getUser())
                .setParams(job.getParams())
                .setVariableMap(job.getVariableMap())
