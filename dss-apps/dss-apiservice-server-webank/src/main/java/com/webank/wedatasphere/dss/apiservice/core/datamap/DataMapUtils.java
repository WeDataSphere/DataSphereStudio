...
//            "/front/dgsa/openapi/form/request/queryStepType").getValue();
    ...
    private static final String DATAMAP_APPID = CommonVars.apply("wds.dss.api.datamap.appid",
            "75116e6f690e6d222fb55f2dd6f9cb5a").getValue();
    private static final String DATAMP_APPTOKEN = CommonVars.apply("wds.dss.api.datamap.apptoken",
            "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1aWQiOiJjb29wZXJ5YW5nIiwiYXBwa2V5IjoiNzUxMTZlNmY2OTBlNmQyMjJmYjU1ZjJkZDZmOWNiNWEiLCJpYXQiOjE1NzE4MTQxOTYzNDZ9.JfjvsiNMWSc1RnQh1k7vsNjwp4YRquT_XXbYmlEgBgc").getValue();
    private static final String DEFAULT_NONCE = CommonVars.apply("wds.dss.api.datamap.nonce", "56689").getValue();
    private static final String DATAMAP_USER = CommonVars.apply("wds.dss.api.datamap.user", "allenlliu").getValue();
    private static final String DATAMAP_NOTIFY_USER = CommonVars.apply("wds.dss.api.datamap.notify.user", "allenlliu,jinyangrao").getValue();
    ...
    public static final Integer DATAMAP_SOCKET_TIME_OUT = CommonVars.apply("wds.dss.api.datamap.socket.timeout",60000 ).getValue();
    ...
    public static boolean applyDataMap(String otthId,
        ...
        String response = HttpClientUtil.postJsonBody(applyUrl, DATAMAP_SOCKET_TIME_OUT, new HashMap<>(), reqJson, "UTF-8");
    ...
    public static Map<String, String> getDevPrincipalsAndStatus(String dbName, String tableName, String env, String clusterType) throws Exception {
        ...
        String response = HttpClientUtil.postJsonBody(requestUrl, DATAMAP_SOCKET_TIME_OUT, new HashMap<>(), reqJson, "UTF-8");
        LOGGER.info("response is {}", response);
        JsonParser jsonParser = new JsonParser();
        JsonObject jsonObject = jsonParser.parse(response).getAsJsonObject();
        int retCode = jsonObject.get("retCode").getAsInt();
