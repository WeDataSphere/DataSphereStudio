...
public interface ApiServiceDao {
    ...
    List<ApiServiceVo> queryByWorkspaceId(@Param("workspaceId") Integer workspaceId, @Param("userName") String userName, @Param("type") String type);

    Integer updateApiServiceComment(@Param("id") Long id, @Param("comment") String comment);

    List<ApiServiceVo> queryApiServiceById(@Param("list") List<Long> list,@Param("type") String type);
